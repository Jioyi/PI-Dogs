				...
				<div className="pop-up">
					...
					<div className="content-container">
						<p className="content-text">
							...
							temperaments, ratings and more. If you are looking for your ideal
							dog, I invite you to make your own search
						</p>
						<button onClick={()=> history.push("/home")} className="button-enter">
							<div
								style={{
									display: 'flex',
